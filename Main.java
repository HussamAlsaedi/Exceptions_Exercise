...
/*
        try {
            ...
            if (count_numbers <= 0) {
                throw new IllegalArgumentException("Count of numbers must be greater than zero.");
            }
 ...
 * 18 - Determine and print the number of times the character ‘a’ appears in the input entered by the user.*/
    ...
    public static void  check_seconds (int seconds) throws  Exception{
        if (seconds <= 120) {
